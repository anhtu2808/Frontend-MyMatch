      ...
      <div className="max-w-5xl mx-auto py-10 px-4">
        ...
        <div className="bg-gray-100 rounded-xl p-6 mt-6 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold">Khung giờ học</label>
              <Select
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold">Hình thức học</label>
              <Select
                placeholder="Ví dụ: In-person, Online, Hybrid"
                value={mode}
                onChange={setMode}
                className="w-full rounded-full"
                size="large"
