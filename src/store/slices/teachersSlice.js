...
const initialState = {
  teachers: [
    ...
    },
    {
      ...
      bio: "Chuyên gia về AI/ML với nhiều công trình nghiên cứu được công bố quốc tế.",
      reviewData: [
        {
          id: 1,
          title: "Giảng dạy xuất sắc",
          content: "Phương pháp giảng dạy sáng tạo, luôn cập nhật kiến thức mới. Rất đáng để học từ cô.",
